                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 5,),
                            Text(experiences[index].company, style: const TextStyle(fontSize: 17, fontWeight: FontWeight.bold),),
                          ],
                        ),
                        const SizedBox(width: 8,),
                        const Text(" - "),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 5,),
                            Text(experiences[index].location, style: const TextStyle(fontSize: 17, fontWeight: FontWeight.bold),),
                          ],
                        ),
                      ],
                    ),
