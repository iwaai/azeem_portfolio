...
import 'package:jibrantalib/Models/project.dart';
import 'package:jibrantalib/Widgets/formatted_text.dart';
  ...
  _showProjectDialog(BuildContext context, Project project) async {
    Widget errorDialog = Padding(
      padding: EdgeInsets.symmetric(
          horizontal: Get.width <= 500 ? 0 : 50,
          vertical: Get.width <= 500 ? 0 : 50),
      child: Dialog(
        shape:
        ...
        Wrap(
          ...
          children: [
            ...
            project.url == null
                ...
                : ElevatedButton(
                    onPressed: () async {
                      await launchUrl(Uri.parse(project.url.toString()),
                          mode: LaunchMode.externalApplication);
                    },
                    child: Text(
                      project.isWeb == true ? "View Website" : "Download App",
