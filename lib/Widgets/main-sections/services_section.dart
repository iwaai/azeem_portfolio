  ...
  Widget build(BuildContext context) {
    return GetBuilder<MainController>(
        ...
        builder: (controller){
          return Column(
            children: [
              const Text("Services", style: TextStyle(fontSize: 36, fontWeight: FontWeight.bold, fontFamily: 'Poppins'),),
                        ...
                        child: FlipCard(
                            front: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  SvgPicture.asset(e.icon, width: 40, height: 40, color: Theme.of(context).primaryColor,),
                              ...
                              child: Column(
                                children: [
                                          ...
                                          itemBuilder: (context, index){
                                            return Row(
                                              children: [
                                                ...
                                                Text(e.description[index], style: const TextStyle(fontWeight: FontWeight.bold),),
                                              ],
                                            );
                                          },
                                  ...
                                  ElevatedButton(
                                      ...
                                      child: const Text("Hire Me", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),)
                                  ),
