  ...
  Widget build(BuildContext context) {
    return GetBuilder<MainController>(
        ...
        builder: (controller) {
          return FB5Row(
              classNames:
                  'col-12 px-${Get.width <= mobileWidth ? "2" : "8"} align-items-center justify-content-center pb-5',
              children: [
                FB5Col(
                ...
                FB5Col(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // SizedBox(height: 20,),
                        const Text(
                          "I am available for project based, full-time, part-time remote positions.",
                          style: TextStyle(
                        ...
                        FB5Row(
                          ...
                          children: controller.contacts.map((e) {
                            return FB5Col(
                              classNames:
                                  'col-12 col-md-6 col-lg-4 col-xl-4 p-2',
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Row(
